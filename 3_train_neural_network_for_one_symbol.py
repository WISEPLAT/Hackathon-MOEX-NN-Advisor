"""
    ...
    После обучения, лучшая модель НС сохраняется автоматом в папку NN_winner_folder.
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    timeframe_0 = Config.timeframe_0  # таймфрейм для обучения нейросети
    NN_winner_folder = "NN_winner_one"  # папка в которую будем сохранять лучшие модели
